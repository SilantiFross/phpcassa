...
interface CassandraIf {
  ...
  public function multiget_slice($keys, ColumnParent $column_parent, SlicePredicate $predicate, $consistency_level);
  public function multiget_count($keys, ColumnParent $column_parent, SlicePredicate $predicate, $consistency_level);
...
class CassandraClient implements CassandraIf
{
  ...
  public function send_multiget_slice($keys, ColumnParent $column_parent, SlicePredicate $predicate, $consistency_level)
  {
  ...
  public function send_multiget_count($keys, ColumnParent $column_parent, SlicePredicate $predicate, $consistency_level)
  {
